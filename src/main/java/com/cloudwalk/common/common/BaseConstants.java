 ...
 * File Name:BaseConstants.java
 * Package Name:com.linc.usermanager.util
 * Date:2015年4月10日下午2:41:16
...
public class BaseConstants {
	 ...
	 */
	public static final String downloadOrUpLoadFilepath = "WEB-INF\\classes\\";
	...
	/**
	 * NULL_UPLOADIMG_ERROR : 上传文件为空
	 */
	public static final String NULL_UPLOADFILE_ERROR = "{\"code\":\"-1\",\"message\":\"上传文件为空\"}";
